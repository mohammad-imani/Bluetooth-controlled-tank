...
clockwise and counter-clockwise rotation,stopping, and speed control. Here, however, we need to go a step further.
...
spin in place, the tracks must rotate in opposite directions.
